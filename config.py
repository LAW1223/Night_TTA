...
class Configuration():
	def __init__(self):
		...
		self.OPTIM_BETA=0.9
		self.OPTIM_WD=0.
		self.OPTIM_MOMENTUM=0.999
		self.OPTIM_DAMPENING=0.0
		self.OPTIM_NESTEROV=True
